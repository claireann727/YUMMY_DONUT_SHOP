...
<body><header class="navbar"><a class="logo" href="index.php" style="display: flex; align-items: center; gap: 10px; text-decoration: none;"><img src="images/logo.png" alt="Yummy Donut Logo" style="height: 40px; width: auto; object-fit: contain;"><span>YUMMY DONUT ADMIN</span></a><nav><ul class="nav-links"><li><a href="index.php">STORE</a></li><li><a href="logout.php">LOGOUT</a></li></ul></nav></header>
