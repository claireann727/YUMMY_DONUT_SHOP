...
<head>
    ...
    <title>Admin Dashboard | Yummy Donut</title>
...
<main class="page">
    ...
    <div class="stats">
        ...
        <div><b><?= $orderCount ?></b><span>Orders</span></div>
        <div><b>₱<?= number_format($sales, 2) ?></b><span>Total Sales</span></div>
    </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <form method="post" class="inline-form">
                                ...
                                <select name="status">
                                    <?php foreach (["Pending", "Preparing", "Out for Delivery", "Completed", "Cancelled"] as $status): ?>
