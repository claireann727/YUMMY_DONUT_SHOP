...
<body>
<header class="navbar"><a class="logo" href="index.php">YUMMY DONUT</a><nav><ul class="nav-links"><li><a href="index.php">HOME</a></li><li><a href="index.php#menu">MENU</a></li><li><a href="login.php">ACCOUNT</a></li></ul></nav></header>
<main class="page">
